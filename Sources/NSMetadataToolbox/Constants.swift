// TODO: Should this constant be available on other platforms?
...
// NOTE: The `kMDItemSupportFileType` in CoreServices is deprecated as of macOS 10.5,
// but some files still have values for the attribute.
/// The constant for
